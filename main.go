...
func main() {
	flag.Usage = func() {
		fmt.Fprintln(flag.CommandLine.Output(), "Bits of Unsolicited Advice from https://kk.org/thetechnium/68-bits-of-unsolicited-advice/ and https://kk.org/thetechnium/99-additional-bits-of-unsolicited-advice/")
	}
	...
	fmt.Println(advices[rand.Intn(len(advices))])
}
